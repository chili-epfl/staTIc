   ...
   onNumberChanged: {
       ...
       switch (d3){
            case 0:
                ...
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/0.obj"
                break;
            case 1:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/1.obj"
                break;
            case 2:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/2.obj"
                break;
            case 3:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/3.obj"
                break;
            case 4:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/4.obj"
                break;
            case 5:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/5.obj"
                break;
            case 6:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/6.obj"
                break;
            case 7:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/7.obj"
                break;
            case 8:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/8.obj"
                break;
            case 9:
                third_digit.enabled=true;
                third_digit.mesh.source="qrc:/UIMesh/3DObjects/9.obj"
                break;
       }
       switch (d4){
            case 0:
